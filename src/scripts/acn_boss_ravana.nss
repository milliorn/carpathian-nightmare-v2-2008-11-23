    ...
    while (GetIsObjectValid(oPartyMember) == TRUE) {
         ...
         if (GetArea(oPartyMember) == oArea)
         {
            ...
            else
            {
                ...
                "You have won the challenge.  Grab the Key from the corpse, get"+
                " a token an open the door to exit to claim your prize" , TALKVOLUME_TALK)));
                ...
                if (oPartyMember == oKiller)
                    ...
                    SendMessageToAllDMs(sName+" slayed " + sBoss);
            }
        }
