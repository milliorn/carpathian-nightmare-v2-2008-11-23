...
void main()
{
    ...
    {
        SendMessageToAllDMs(sPlayerName + "<cóóó> has possibly stolen <cóó >"+ sName +
        "</c> from <c ó >"+sItemOwnerName+".</c> an has been punished for repeated"+
        ...
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectCutsceneImmobilize(), oFrom, 6.0);
        return;
    }
