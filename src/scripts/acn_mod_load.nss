...
void main()
{
    object oModule = GetAreaFromLocation(GetStartingLocation()),
           oTome = GetObjectByTag("TheBookOfLegendaryLevels"),
           oDial = GetObjectByTag("Sundial"),
           oBoard = GetObjectByTag("Scoreboard"),
           oPit = GetObjectByTag("CenterRing"),
           oTown = GetObjectByTag("CarpathianCircle"),
           oGary = GetObjectByTag("GaryGygaxMemorial"),
           oAltar = GetObjectByTag("donations_chest");
    ...
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, SupernaturalEffect(EffectVisualEffect(VFX_DUR_SMOKE)), oAltar);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, SupernaturalEffect(EffectVisualEffect(VFX_DUR_SPELLTURNING)), oDial);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, SupernaturalEffect(EffectVisualEffect(VFX_DUR_MIND_AFFECTING_FEAR)), oBoard);
    ...
    //SetFogAmount(FOG_TYPE_ALL, d20(2), oModule);
