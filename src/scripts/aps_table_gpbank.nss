...
void main()
{
    ...
    {
        SQLExecDirect("DROP TABLE BANK_GOLD");
        SendMessageToPC(oPC, "Table 'BANK_GOLD' deleted.");


        // For Access

        SQLExecDirect("CREATE TABLE BANK_GOLD (" +
                        "player text(64)," +
                        "tag text(64)," +
                        "name text(64)," +
                        "val memo," +
        ...
        */
        ...
        SendMessageToPC(GetLastUsedBy(), "Table 'BANK_GOLD' created.");
    }
}
