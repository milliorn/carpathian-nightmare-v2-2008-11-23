...
void main()
{
    ...
    {
        SQLExecDirect("DROP TABLE Hermes");
        SendMessageToPC(oPC, "Table 'Hermes' deleted.");


        // For Access

        SQLExecDirect("CREATE TABLE Hermes (" +
                        "player text(64)," +
                        "tag text(64)," +
                        "name text(64)," +
                        "val memo," +
        ...
        */
        ...
        SendMessageToPC(GetLastUsedBy(), "Table 'Hermes' created.");
    }
}
