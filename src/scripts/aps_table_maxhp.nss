...
void main()
{
    ...
    {
        SQLExecDirect("DROP TABLE MAXHP");
        SendMessageToPC(oPC, "Table 'MAXHP' deleted.");


        // For Access

        SQLExecDirect("CREATE TABLE MAXHP (" +
                        "player text(64)," +
                        "tag text(64)," +
                        "name text(64)," +
                        "val memo," +
        ...
        */
        ...
        SendMessageToPC(GetLastUsedBy(), "Table 'MAXHP' created.");
    }
}
