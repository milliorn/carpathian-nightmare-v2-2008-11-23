...
void main()
{
    ...
    {
        SQLExecDirect("DROP TABLE PCNAME");
        SendMessageToPC(oPC, "Table 'PCNAME' deleted.");


        // For Access

        SQLExecDirect("CREATE TABLE PCNAME (" +
                        "player text(64)," +
                        "tag text(64)," +
                        "name text(64)," +
                        "val memo," +
        ...
        */
        ...
        SendMessageToPC(GetLastUsedBy(), "Table 'PCNAME' created.");
    }
}
