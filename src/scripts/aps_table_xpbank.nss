...
void main()
{
    ...
    {
        SQLExecDirect("DROP TABLE BANK_XP");
        SendMessageToPC(oPC, "Table 'BANK_XP' deleted.");


        // For Access

        SQLExecDirect("CREATE TABLE BANK_XP (" +
                        "player text(64)," +
                        "tag text(64)," +
                        "name text(64)," +
                        "val memo," +
        ...
        */
        ...
        SendMessageToPC(GetLastUsedBy(), "Table 'BANK_XP' created.");
    }
}
