void main()
{
   ...
   if (!GetLocalInt(OBJECT_SELF, "TIMER_" + sName))
   {
       ...
       DelayCommand(60.0, DeleteLocalInt(OBJECT_SELF, "TIMER_" + sName));
   ...
   {
       FloatingTextStringOnCreature("<c ó >Anti Spamming Code - <cóóó>you may only use this once per 60 seconds", oPC);
   }
}
