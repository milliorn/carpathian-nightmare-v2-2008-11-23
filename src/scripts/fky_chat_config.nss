...
const int ENABLE_PLAYER_SETTAILWINGS = TRUE;//Set this to TRUE to allow players to use the !settail and !setwings commands.
...
const int SEND_CHANNELS_TO_CHAT_LOG = FALSE;//Set this to FALSE if you want languages, listening, and metachannels
...
//
//DM Listening//////////////////////////////////////////////////////////////////
const int DMS_HEAR_TELLS = TRUE;//Set this to TRUE if you want people listed in the VerifyDMKey function
...
//
const int DM_PLAYERS_HEAR_META = TRUE;///Set this to TRUE if you want DMs logged in as players
//to receive all DM messages in their combat logs. This will route DM messages to anyone with a cdkey you
...
const int DISALLOW_SPEECH_WHILE_SILENCED = TRUE;//Set to TRUE to disable speech by silenced players on one,
//several, or all chat channels. Then set the constants for the channels you want to disable to TRUE.
//These channels will only block player speakers, not DM speakers, and not DMs logged in as players.

const int DISABLE_SILENCED_TALK = TRUE;
const int DISABLE_SILENCED_SHOUT = TRUE;
const int DISABLE_SILENCED_WHISPER = TRUE;
const int DISABLE_SILENCED_TELL = TRUE;
const int DISABLE_SILENCED_PARTY = TRUE;
const int DISABLE_SILENCED_DM = FALSE;

const int DISALLOW_METASPEECH_WHILE_SILENCED = TRUE;//Set to TRUE to disable speech by silenced players on
//metachannels. This setting is seperate from the above commands, and can be enabled even if
...
const string VAULTPATH_CHAT = "C:/NeverwinterNights/NWN/servervault/";
...
const int LETO_FOR_ADMINS_ONLY = TRUE;//Set this to TRUE if you want to prevent dungeon masters from
...
int VerifyDMKey(object oPlayer)
{
    string sName = GetPCPublicCDKey(oPlayer);
    if (//sName == "Q76AMR3T" || //darryhick
        //sName == "QG6L7N3D" || //goldenpanda
        //sName == "QGM9NWGF" || //Jasper Tbe Swift
        //sName == "QGML66J4" || //Lady Mistress of ACN & Yoda
        //sName == "FFUCKG7Y" || //vvn Harley
        sName == "Q7KLK4VN" || //YeahToast
...
//  milliorn                    =   QG6CXEYC
//  milliorn                    =   Q76A43RL
//  fooshwa - sarah                    =   QG6QREW7
//  Elwoodini                   =   QC79CL3G
//  Elwoodini                   =   QVR9HDJH
//  The Bloodless               =   QV69QWHT
//  Emeta                       =   QV6WNDPT
//  AL Music                    =   QVR9TUQP
//  darryhick                   =   Q76AMR3T
//  RoadWyrm                    =   QVRFKQ9Q
//  personaly don't care        =   FTM3F7DY
//  awasher                     =   FT6M9FTN
//  Karyn                       =   QVRVRKUG
//  badkittyrulz - ana catucus dea               =   QV46YGUD
//  M_Theory                    =   FTRML7FX
//  DM_Dorrian                  =   QG6DVQUE
//  Moe of the HBros Clan       =   QC4N4CKG
//  Starlandra                  =   QVRLWPNP
//  grathor_pantheris           =   QC7RC6RU
//  imgonnagetu                 =   QVRFE9XG
...
int VerifyAdminKey(object oPlayer)
{
    ...
    if (sCDKey == "QG6CXEYC" ||
        ...
        sCDKey == "QG6DVQUE" /*Dorrian*/ ||  sCDKey == "QG6ECNPX" /*Laptop*/ ||
        sCDKey == "QG6DVL7U" /*Shimmer*/|| sCDKey == "QGMQ47EY" /*CD 4*/)
    {
        return TRUE;
    }
    else return FALSE;
...
//
const int ENABLE_FULL_LANGUAGE_LIST_FOR_PLAYERS = TRUE;//Set this to true if you want players to be able
...
const string TAG_OF_LANGUAGE_STORAGE_OBJECT = "chatcommands";
const string RESREF_OF_LANGUAGE_STORAGE_OBJECT = "chatcommands";
