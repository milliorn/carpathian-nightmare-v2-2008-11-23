...
//    SF_SetSubraceSpellResistance("Rakshasa-Tiger", 32);
    ...
    SF_SetSubraceFeat("Rakshasa-Tiger", FEAT_DODGE);
    SF_SetSubraceFeat("Rakshasa-Tiger", FEAT_ALERTNESS);
    SF_SetSubraceMovementSpeed("Rakshasa-Tiger", CHARACTER_SPEED_FAST);
    SF_SetSubraceClassRestriction("Rakshasa-Tiger", ALLOW_USE_TRUE, CLASS_RESTRICT_SORCERER | CLASS_RESTRICT_WIZARD, 1);
}
...
//    SF_SetSubraceSpellResistance("Rakshasa-Bear", 32);
    ...
    SF_SetSubraceFeat("Rakshasa-Bear", FEAT_DODGE);
    SF_SetSubraceFeat("Rakshasa-Bear", FEAT_ALERTNESS);
    SF_SetSubraceMovementSpeed("Rakshasa-Bear", CHARACTER_SPEED_FAST);
    SF_SetSubraceClassRestriction("Rakshasa-Bear", ALLOW_USE_TRUE, CLASS_RESTRICT_SORCERER | CLASS_RESTRICT_WIZARD, 1);
}
...
//    SF_SetSubraceSpellResistance("Rakshasa-Wolf", 32);
    ...
    SF_SetSubraceFeat("Rakshasa-Wolf", FEAT_DODGE);
    SF_SetSubraceFeat("Rakshasa-Wolf", FEAT_ALERTNESS);
    SF_SetSubraceMovementSpeed("Rakshasa-Wolf", CHARACTER_SPEED_FAST);
    SF_SetSubraceClassRestriction("Rakshasa-Wolf", ALLOW_USE_TRUE, CLASS_RESTRICT_SORCERER | CLASS_RESTRICT_WIZARD, 1);
}
...
void LoadSubrace_Ettin()
{
    ...
    SF_SetSubraceFeat("Ettin", FEAT_POWER_ATTACK);
    SF_SetSubraceFeat("Ettin", FEAT_DARKVISION);
...
void LoadSubrace_HillGiant()
{
    ...
    SF_SetSubraceFeat("Hill-Giant", FEAT_CLEAVE);
    SF_SetSubraceFeat("Hill-Giant", FEAT_POWER_ATTACK);
    SF_SetSubraceFeat("Hill-Giant", FEAT_WEAPON_FOCUS_CLUB);
}
...
void LoadSubrace_StoneGiant()
{
    ...
    SF_SetSubraceFeat("Stone-Giant", FEAT_POWER_ATTACK);
...
void LoadSubrace_FrostGiant()
{
    ...
    SF_SetSubraceFeat("Frost-Giant", FEAT_CLEAVE);
    SF_SetSubraceFeat("Frost-Giant", FEAT_GREAT_CLEAVE);
    SF_SetSubraceFeat("Frost-Giant", FEAT_POWER_ATTACK);
}
