...
//    SF_SetSubraceEquipmentRestriction("Dwarf-Artic", ALLOW_USE_TRUE, EQUIP_RESTRICT_ARMOUR_CLOTH | EQUIP_RESTRICT_ARMOUR_LIGHT | EQUIP_RESTRICT_SHIELD_SMALL);
//    SF_SetSubraceEquipmentRestriction("Dwarf-Artic", ALLOW_USE_FALSE, EQUIP_RESTRICT_WEAPON_LARGE);
    SF_SetSubraceFeat("Dwarf-Artic", FEAT_RESIST_ENERGY_COLD);
    SF_SetSubraceFeat("Dwarf-Artic", FEAT_EPIC_ENERGY_RESISTANCE_COLD_1);
}
...
void LoadSubrace_Azer()
{
    ...
    SF_SetSubraceAlignmentRestriction("Azer", ALLOW_USE_TRUE, ALIGN_RESTRICT_LAWFUL | ALIGN_RESTRICT_NEUTRAL2);
//    SF_SetSubraceSpellResistance("Azer", 12);
}
...
void LoadSubrace_DeepDwarf()
{
    ...
    SF_SetSubraceAlignmentRestriction("Dwarf-Deep", ALLOW_USE_TRUE, ALIGN_RESTRICT_LAWFUL | ALIGN_RESTRICT_NEUTRAL2);
...
//    SF_SetSubraceSpellResistance("Dwarf-Derro", 18);
