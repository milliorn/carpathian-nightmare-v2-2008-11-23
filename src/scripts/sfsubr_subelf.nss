...
//    SF_SetSubraceEquipmentRestriction("Elf-Aquatic", ALLOW_USE_FALSE, EQUIP_RESTRICT_ARMOUR_HEAVY | EQUIP_RESTRICT_ARMOUR_MEDIUM);
    ...
    SF_SetSubraceFeat("Elf-Aquatic", FEAT_DARKVISION);
...
void LoadSubrace_Avariel()
{
    ...
    SF_SetSubraceFeat("Avariel", FEAT_SKILL_FOCUS_SPOT);
    ...
    SF_SetSubraceMovementSpeed("Avariel", CHARACTER_SPEED_VERYFAST);
//    SF_SetSubraceEquipmentRestriction("Avariel", ALLOW_USE_TRUE, EQUIP_RESTRICT_ARMOUR_LIGHT | EQUIP_RESTRICT_ARMOUR_CLOTH);
}
...
//    SF_SetSubraceSpellResistance("Drow", 12);
...
//    SF_SetSubraceEquipmentRestriction("Elf-Wood", ALLOW_USE_TRUE, EQUIP_RESTRICT_ARMOUR_LIGHT);
...
void LoadSubrace_Drider()
{
    ...
    SF_SetSubraceFeat("Drider", FEAT_AMBIDEXTERITY);
    SF_SetSubraceFeat("Drider", FEAT_COMBAT_CASTING);
    SF_SetSubraceFeat("Drider", FEAT_TWO_WEAPON_FIGHTING);
//    SF_SetSubraceSpellResistance("Drider", 14);
