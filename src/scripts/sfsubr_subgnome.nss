...
//    SF_SetSubraceSpellResistance("Svirfneblin", 11);
...
void LoadSubrace_ForestGnome()
{
    ...
    SF_SetSubraceAlignmentRestriction("Gnome-Forest", ALLOW_USE_TRUE, ALIGN_RESTRICT_NEUTRAL1 | ALIGN_RESTRICT_NEUTRAL2);
}
...
void LoadSubrace_Troglodyte()
{
    ...
    SF_SetSubraceFeat("Troglodyte", FEAT_DARKVISION);
...
void LoadSubrace_Yuanti()
{
    ...
    SF_SetSubraceVoiceSet("Yuan-ti", 108, 240);
...
void LoadSubrace_Gnoll()
{
    ...
    SF_SetSubraceVoiceSet("Gnoll", 251, 252);
    SF_SetSubracePortrait("Gnoll", "po_Ginger_", "po_fginger_");
    SF_SetSubraceFeat("Gnoll", FEAT_DARKVISION);
}
...
void LoadSubrace_Minotaur()
{
    ...
    SF_SetSubraceVoiceSet("Minotaur", 64, 64);
    SF_SetSubracePortrait("Minotaur", "po_Minotaur_","po_MinoWiz_");
//    SF_SetSubraceEquipmentRestriction("Minotaur", ALLOW_USE_FALSE, EQUIP_RESTRICT_WEAPON_TINY | EQUIP_RESTRICT_WEAPON_SMALL);
    SF_SetSubraceFeat("Minotaur", FEAT_KEEN_SENSE);
    SF_SetSubraceFeat("Minotaur", FEAT_GREAT_FORTITUDE);
    SF_SetSubraceFeat("Minotaur", FEAT_POWER_ATTACK);
    SF_SetSubraceFeat("Minotaur", FEAT_SKILL_FOCUS_LISTEN);
    SF_SetSubraceFeat("Minotaur", FEAT_SKILL_FOCUS_SEARCH);
    SF_SetSubraceFeat("Minotaur", FEAT_SKILL_FOCUS_SPOT);
}
...
void LoadSubrace_Orc()
{
    ...
    SF_SetSubraceVoiceSet("Orc", 73, 73);
    SF_SetSubraceFeat("Orc", FEAT_ALERTNESS);
    SF_SetSubraceClassRestriction("Orc", ALLOW_USE_TRUE, CLASS_RESTRICT_BARBARIAN, 1);
//    SF_SetSubraceEquipmentRestriction("Orc", ALLOW_USE_FALSE, EQUIP_RESTRICT_WEAPON_TINY | EQUIP_RESTRICT_WEAPON_SMALL);
...
//    SF_SetSubraceEquipmentRestriction("Medusa", ALLOW_USE_FALSE, EQUIP_RESTRICT_WEAPON_LARGE | EQUIP_RESTRICT_ARMOUR_HEAVY);
    ...
    SF_SetSubraceFeat("Medusa", FEAT_WEAPON_FINESSE);
    SF_SetSubraceVoiceSet("Medusa", 308, 345);
...
//    SF_SetSubraceSpellResistance("Sea-Hag", 14);
