...
void LoadSubrace_Dryad()
{
    ...
    SF_SetSubraceAlignmentRestriction("Dryad", ALLOW_USE_TRUE, ALIGN_RESTRICT_GOOD | ALIGN_RESTRICT_LAWFUL | ALIGN_RESTRICT_NEUTRAL2 | ALIGN_RESTRICT_CHAOTIC);
...
//    SF_SetSubraceEquipmentRestriction("Dryad", ALLOW_USE_TRUE, EQUIP_RESTRICT_ARMOUR_CLOTH);
//    SF_SetSubraceEquipmentRestriction("Dryad", ALLOW_USE_TRUE, EQUIP_RESTRICT_WEAPON_TINY | EQUIP_RESTRICT_WEAPON_SMALL);
    SF_SetSubraceFeat("Dryad", FEAT_DODGE);
    SF_SetSubraceFeat("Dryad", FEAT_ALERTNESS);
    SF_SetSubraceFeat("Dryad", FEAT_IMPROVED_INITIATIVE);
    SF_SetSubraceVoiceSet("Dryad", 31, 197);
}

void LoadSubrace_Nymph()
{
    SF_CreateNewSubrace("Nymph", APPEARANCE_TYPE_NYMPH, APPEARANCE_TYPE_NYMPH);
    SF_SetSubraceVoiceSet("Nymph", 197, 197);
    ...
    SF_SetSubraceFeat("Nymph", FEAT_DODGE);
    SF_SetSubraceFeat("Nymph", FEAT_ALERTNESS);
    SF_SetSubraceFeat("Nymph", FEAT_IRON_WILL);
//    SF_SetSubraceEquipmentRestriction("Nymph", ALLOW_USE_TRUE, EQUIP_RESTRICT_ARMOUR_CLOTH);
//    SF_SetSubraceEquipmentRestriction("Nymph", ALLOW_USE_TRUE, EQUIP_RESTRICT_WEAPON_TINY | EQUIP_RESTRICT_WEAPON_SMALL);
    SF_SetSubraceVoiceSet("Dryad", 197, 197);
}
...
//    SF_SetSubraceEquipmentRestriction("Pixie", ALLOW_USE_TRUE, EQUIP_RESTRICT_ARMOUR_CLOTH);
//    SF_SetSubraceEquipmentRestriction("Pixie", ALLOW_USE_TRUE, EQUIP_RESTRICT_WEAPON_TINY | EQUIP_RESTRICT_WEAPON_SMALL);
    SF_AdjustSubraceStats("Pixie", -2, 2, 0, 0, 0, 0);
//    SF_SetSubraceSpellResistance("Pixie", 16);
    SF_SetSubraceFeat("Pixie", FEAT_DODGE);
    SF_SetSubraceFeat("Pixie", FEAT_POINT_BLANK_SHOT);
    SF_SetSubraceFeat("Pixie", FEAT_RAPID_SHOT);
    SF_SetSubraceFeat("Pixie", FEAT_WEAPON_FINESSE);
    SF_SetSubracePortrait("Pixie", "po_pixie_","po_pixie_");
    SF_SetSubraceVoiceSet("Pixie", 37, 37);
}
...
void LoadSubrace_Goblin()
{
    ...
    SF_SetSubraceVoiceSet("Goblin", 203, 203);
    ...
    SF_SetSubraceFeat("Goblin", FEAT_DARKVISION);
    SF_SetSubraceFeat("Goblin", FEAT_ALERTNESS);
    SF_SetSubraceFeat("Goblin", SKILL_MOVE_SILENTLY);
//    SF_SetSubraceEquipmentRestriction("Goblin", ALLOW_USE_FALSE, EQUIP_RESTRICT_ARMOUR_HEAVY | EQUIP_RESTRICT_SHIELD_TOWER | EQUIP_RESTRICT_WEAPON_LARGE);
}
...
void LoadSubrace_Hobgoblin()
{
    ...
    SF_SetSubraceFeat("Hobgoblin", FEAT_DARKVISION);
    SF_SetSubraceFeat("Hobgoblin", SKILL_MOVE_SILENTLY);
    ...
    SF_SetSubraceVoiceSet("Goblin", 253, 254);
}
...
void LoadSubrace_Asabi()
{
    ...
    SF_SetSubraceVoiceSet("Asabi", 311, 311);
...
//    SF_SetSubraceEquipmentRestriction("Kobold", ALLOW_USE_FALSE, EQUIP_RESTRICT_ARMOUR_HEAVY | EQUIP_RESTRICT_SHIELD_TOWER | EQUIP_RESTRICT_WEAPON_LARGE);
    ...
    SF_SetSubraceVoiceSet("Kobold", 246, 247);
}
...
void LoadSubrace_Lizardfiend()
{
    ...
    SF_SetSubraceVoiceSet("Lizardfiend", 60, 57);
    ...
    SF_SetSubraceVoiceSet("Lizardfiend", 209, 58);
}
...
//    SF_SetSubraceEquipmentRestriction("Sahuagin", ALLOW_USE_TRUE, EQUIP_RESTRICT_ARMOUR_CLOTH | EQUIP_RESTRICT_ARMOUR_LIGHT);
//    SF_SetSubraceEquipmentRestriction("Sahuagin", ALLOW_USE_FALSE, EQUIP_RESTRICT_WEAPON_LARGE);
    ...
    SF_SetSubraceFeat("Sahuagin", FEAT_SKILL_FOCUS_LISTEN);
    SF_SetSubraceFeat("Sahuagin", FEAT_SKILL_FOCUS_HIDE);
    SF_SetSubraceFeat("Sahuagin", FEAT_SKILL_FOCUS_SPOT);
