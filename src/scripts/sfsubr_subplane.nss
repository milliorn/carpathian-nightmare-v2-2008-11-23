...
void LoadSubrace_Aasimar()
{
    ...
    SF_SetSubraceFeat("Aasimar", FEAT_DARKVISION);
...
{
    SF_CreateNewSubrace("Tiefling", APPEARANCE_TYPE_INVALID, APPEARANCE_TYPE_INVALID, "sfsub_aasimar_hide");
    ...
    SF_SetSubraceFeat("Tiefling", FEAT_DARKVISION);
...
void LoadSubrace_Feyri()
{
    ...
    SF_SetSubraceFeat("Fey-ri", FEAT_DARKVISION);
}
...
void LoadSubrace_AirGenasi()
{
    ...
    SF_SetSubraceMovementSpeed("Air-Genasi", CHARACTER_SPEED_FAST);
}
...
void LoadSubrace_WaterGenasi()
{
    ...
    SF_SetSubraceAlignmentRestriction("Water-Genasi", ALLOW_USE_TRUE, ALIGN_RESTRICT_NEUTRAL1 | ALIGN_RESTRICT_NEUTRAL2);
}
...
void LoadSubrace_Ettercap()
{
    ...
    SF_SetSubraceFeat("Ettercap", FEAT_SKILL_FOCUS_HIDE);
    SF_SetSubraceFeat("Ettercap", FEAT_SKILL_FOCUS_SPOT);
    SF_SetSubracePortrait("Ettercap", "po_Ettercap_", "po_Ettercap_");
    SF_SetSubraceVoiceSet("Ettercap", 36, 36);
}
...
void LoadSubrace_MindFlayer()
{
    ...
    SF_SetSubraceFeat("Mind-Flayer", FEAT_COMBAT_CASTING);
    SF_SetSubraceFeat("Mind-Flayer", FEAT_DODGE);
    SF_SetSubraceFeat("Mind-Flayer", FEAT_IMPROVED_INITIATIVE);
    SF_SetSubraceFeat("Mind-Flayer", FEAT_SLIPPERY_MIND);
    SF_SetSubracePortrait("Mind-Flayer", "po_mindflayer_", "po_mindflayer2_");
    SF_SetSubraceVoiceSet("Mind-Flayer", 384, 384);
}
...
void LoadSubrace_UmberHulk()
{
    ...
    SF_SetSubraceVoiceSet("Umber-Hulk", 95, 95);
}
