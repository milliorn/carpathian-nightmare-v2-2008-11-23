...
*/
    ...
    FloatingTextStringOnCreature("<cú>This spell is disabled due to no saving throw</c>", OBJECT_SELF);
    SendMessageToPC(OBJECT_SELF,"<cú>This spell is disabled due to no saving throw</c>");
    return;
